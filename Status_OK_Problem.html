...
<head>
    ...
    <link rel="stylesheet" href="css/status_ok_problem.css">
        ...
        <div class="">
          ...
          <ul class="timeline-3">
            <li>
              ...
              <h5>เกิดปัญหาขึ้นระหว่างซ่อม</h5>
              <p class="mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque scelerisque diam
                ...
                <p>ต้องการซ่อมต่อหรือไม่</p>
                <div class="d-grid gap-2 d-md-flex">
                  <button class="btn btn_custom me-md-2" type="button">ยืนยัน</button>
                  <button class="btn btn_custom_no" type="button">ปฎิเสธ</button>
                </div>
            </li>
            <li>
              <h6><i class="uil uil-clock"></i>&nbsp;21 March, 2014</h6>
