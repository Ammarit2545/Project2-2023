        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="action/edit_company_parts.php" method="POST">
                        <!-- Page Heading -->
                        ...
                        <div class="row">
                            ...
                            $sql = "SELECT * FROM company_parts WHERE com_p_id = '$id_com' AND del_flg = '0'";
                            ...
                            <div class="col-sm-4">
                                <!-- <input type="text" class="form-control" name="com_name" id="inputPartType" onblur="checkPartType()" value="<?= $row_c['com_p_name'] ?>" placeholder="กรุณากรอกชื่อบริษัท" required> -->

                                <input type="text" name="com_name" id="inputcom_name" class="form-control" placeholder="กรุณากรอกชื่อบริษัท" value="<?= $row_c['com_p_name'] ?>" required>
                            ...
                            <div class="col-sm-4">
                                <input name="com_tel" type="text" class="form-control" id="inputPassword" placeholder="กรุณากรอกเบอร์โทรศัพท์บริษัท (*ไม่จำเป็น)" value="<?= $row_c['com_p_tel'] ?>" required>
