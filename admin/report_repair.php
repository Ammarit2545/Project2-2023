...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-10">
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row" style="font-size: 11px">รายงานยอดซ่อม(แบบสรุป) ณ วันที่ <span id="currentDate"></span></td>
                        ...
                        <tr>
                            <td scope="row" style="font-size: 11px">Repair total report (summary form) as of date</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <table class="table table-striped table-hover"> <!-- Add table-bordered class -->
            ...
            <tbody>
                ...
                LEFT JOIN repair ON repair.r_id = get_repair.get_r_id 
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $row['get_r_id'] ?? "ไม่มีข้อมูล"; ?>
                        </td>
                        <td>
                            
                                <?php echo $row['r_brand'] ?? "ไม่มีข้อมูล"; ?>
                         
                        </td>
                        <td>
                            <?php echo $row['r_model'] ?? "ไม่มีข้อมูล"; ?>
                        </td>
                        <td>
                            <?php echo $row['r_serial_number'] ?? "ไม่มีข้อมูล"; ?>
                        </td>
                        <td>
                            <?php echo number_format($row['get_r_total']); $total += $row['get_r_total'] ?? "ไม่มีข้อมูล"; ?>
                        </td>
                    </tr>
                <?php
                }
                ?>
                <tr>
                    <td colspan="4">ยอดซ่อมทั้งหมดรวมทั้งสิ้น <?= $i ?> รายการ </td>
                    <td>ยอดที่ได้</td>
    ...
    $mpdf->WriteHTML($html);
    $filename = date('Y-m-d') . ' - รายงานยอดซ่อม_Report.pdf';
