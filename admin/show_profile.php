                ...
                <form id="form_edit" action="action/edit_employee.php?id=<?= $e_id ?>" method="POST">
                    <div class="container-fluid">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="e_fname" id="staticEmail" value="<?= $row['e_fname'] ?>" placeholder="กรุณากรอกชื่อ" disabled>
                            </div>
                            <label for="inputPassword" class="col-sm-1 col-form-label">นามสกุล</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="e_lname" id="inputPassword" value="<?= $row['e_lname'] ?>" placeholder="กรุณากรอกนามสกุล" disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-1 col-form-label">เบอร์โทรศัพท์</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="e_tel" id="inputPassword" value="<?= $row['e_tel'] ?>" placeholder="กรุณากรอกเบอร์โทร" disabled>
                            </div>
                            <label for="inputPassword" class="col-sm-1 col-form-label">เงินเดือน</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="e_salary" id="inputPassword" value="<?= $row['e_salary'] ?>" placeholder="กรุณากรอกชื่อ" disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-1 col-form-label">email</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="inputPassword" value="<?= $row['e_email'] ?>" placeholder="ไม่มีข้อมูล" readonly disabled>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select name="role_id" class="mt-2 form-select" aria-label="Default select example" disabled>
                                    <?php
                                    $role_id = $row['role_id'];
