                ...
                if ($result_e) {
                    ...
                    foreach ($parts as $part) {
                        ...
                        if ($result_s && mysqli_num_rows($result_s) > 0) {
                            ...
                            $select_get = "SELECT r_id FROM get_detail WHERE get_d_id = '$get_d_id' AND del_flg = 0";
                            $result_get = mysqli_query($conn, $select_get);
                            $row_get = mysqli_fetch_array($result_get);

                            $r_id = $row_get['r_id'];

                            $select_get1 = "SELECT get_d_id FROM get_detail WHERE r_id = '$r_id' AND del_flg = 0 ORDER BY get_d_id DESC LIMIT 1";
                            $result_get1 = mysqli_query($conn, $select_get1);
