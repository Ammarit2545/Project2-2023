...
<head>
    ...
    <title>เพิ่มบริษัทอะไหล่ - ANE Electronic</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="action/add_company_parts.php" method="POST">
                        <!-- Page Heading -->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                            <input type="text" class="form-control" name="com_name" id="inputPartType" onkeyup="checkPartType()"  placeholder="กรุณากรอกชื่อบริษัท" required>
                                <input type="text" class="form-control" name="com_id" id="inputPartType"  placeholder="กรุณากรอกรหัส" required hidden>
                                ...
                                <script>
                                    ...
                                    var companyNames = [
                                        <?php
                                        $sql = "SELECT com_p_name FROM company_parts WHERE del_flg = '0'";
                                        $result = mysqli_query($conn, $sql);
                                        while ($row_c = mysqli_fetch_array($result)) {
                                        ?> "<?= $row_c['com_p_name']  ?>", <?php
                                                                        }
                                                                            ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <a href="listview_company_parts.php" class="btn btn-danger" id="cancelButton">ยกเลิก</a>
                            </div>
                        </div>
                                ...
                                document.getElementById('cancelButton').addEventListener('click', function(e) {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            window.location.href = "listview_company_parts.php";
                                        }
                                    });
                                });
                            });
