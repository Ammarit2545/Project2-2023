...
<div id="cancel_value_code" style="display: none;">
    ...
    <br>
    <form id="cancel_status_id_conf" action="action/status/add_doing_send.php" method="POST" enctype="multipart/form-data">
...
<div id="status_doing" style="display: none;">
    ...
    <form id="cancel_status_id_conf_get" action="action/status/add_conf_cancel.php" method="POST" enctype="multipart/form-data">
        ...
        <textarea class="form-control auto-expand" name="rs_detail" id="cancelFormControlTextareaConf" rows="3" required placeholder="กรอกรายละเอียดในการยกเลิกคำส่งซ่อม">การซ่อมดำเนินการสำเร็จเสร็จสิ้น    </textarea>
        <input type="text" name="get_r_id" value="<?= $get_r_id ?>" hidden>
