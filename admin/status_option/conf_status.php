<center>
    ...
    ?>
    <button class="btn btn-danger" onclick="showCancelValue()"><?= $row_q['status_name'] ?></button>
    ...
    ?>
    <button class="btn btn-success" onclick="show_conf_status('<?php echo $row_conf['id']; ?>')">
