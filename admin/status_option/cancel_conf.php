 <center>
                                    <button class="btn btn-danger" onclick="showCancelValue()">ยกเลิกคำส่งซ่อม</button>
                                ...
                                <div id="cancel_value_code" style="display: none;">
                                    ...
                                    <form id="cancel_status_id_conf" action="action/status/add_conf_cancel.php" method="POST" enctype="multipart/form-data">
                                        <label for="cancelFormControlTextareaConf" class="form-label">กรุณาใส่รายละเอียดเพื่อทำการ <p style="display:inline; color : red"> ยกเลิกคำส่งซ่อม</p> :</label>
