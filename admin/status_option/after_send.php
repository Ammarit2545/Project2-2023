...
<div id="cancel_value_code" style="display: none;">
    ...
    <form id="cancel_status_id_conf" action="action/status/add_tracking.php" method="POST" enctype="multipart/form-data">
        ...
        <textarea class="form-control auto-expand" name="rs_detail" id="cancelFormControlTextareaConf" rows="3" required placeholder="กรอกรายละเอียดในการยกเลิกคำส่งซ่อม">ทางเราดำเนินการส่งเครื่องเสียงให้ท่านผ่านผู้ให้บริการจัดส่งพัสดุเรียบร้อยแล้ว</textarea>
