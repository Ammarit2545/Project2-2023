<center>
    ...
    ?>
    <button class="btn btn-success" style="background-color:<?= $row_confg['status_color'] ?>; border : <?= $row_confg['status_color'] ?>" onclick="show_conf_status('<?php echo $row_conf['id']; ?>')">
