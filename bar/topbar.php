...
// When the user scrolls down, show the button and fade it out gradually
...
function handleScroll() {
  if (
    ...
    mybutton.classList.remove("fade-out");
  } else {
    mybutton.classList.add("fade-out");
    mybutton.addEventListener("transitionend", hideButton);
  }
}

// When the button opacity reaches 0, hide the button
function hideButton() {
  if (mybutton.style.opacity === "0") {
    mybutton.style.display = "none";
    mybutton.removeEventListener("transitionend", hideButton);
  }
}
