...
<body>
    ...
    ?>
        <div style="text-align: center; margin-top: 50px;">
            ...
            <p>กดปุ่ม "close" เพื่อออกจากหน้านี้</p>
            <p><a href="add_new_parts.php">กดปุ่มนี้เพื่อเพิ่มอะไหล่</a></p>
        </div>
    <?php
    } else {
    ?>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable  modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <!-- <a  class="btn btn-success">ใช้ทั้งหมด</a> -->
                                            <!-- <a herf="admin/con_parts.php?id=<?= $get_r_id_session ?>" class="btn btn-success">ใช้ทั้งหมด</a> -->
                                            <a href="admin/action/con_parts.php?id=<?= $get_r_id_session ?>" class="btn btn-success">ใช้ทั้งหมด</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
