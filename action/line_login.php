...
{
    #### change your id
    private const CLIENT_ID = '2000280186';
    private const CLIENT_SECRET = 'f01cf127468b90a2a2c5f169c8eb338f';
    private const REDIRECT_URL = 'http://localhost/Project2023/Project2-2023/callback.php';
    ...
    function profileFormIdToken($token = null)
    {
        ...
        $ret = array(
            ...
            'picture' => '',
            'email' => '',
            'line_id' => ''  // Adding the line_id field to store Line ID
        );
        ...
        if (count($payload) == 3) {
            ...
            if (isset($data->sub))  // Check if the Line ID (sub field) is available in the payload
                $ret['line_id'] = $data->sub;
        }
        return (object) $ret;
    }
