            ...
            <div class="card-body">
                ...
                <div id="card_style">
                    <div class="container">
                        ...
                        <br>
                        <br>
                        <h3 class="alert alert-secondary"><a class="btn btn-primary">ขั้นตอนที่ 1</a> : กรอกข้อมูลส่วนตัวของท่าน</h3>
                        <br>
                        <div class="row alert alert-light" style="background-color: white; padding : 10px;">
                            <div class="col-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="fname" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="<?= $_SESSION['fname'] ?>" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <!-- Last Name Here  -->
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="lname" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="<?= $_SESSION['lname'] ?>" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <!-- Last Name Here  -->
                                ...
                                <div class="input-group mb-3">
                                    <!-- <span class="input-group-text" id="basic-addon3">นามสกุล</span> -->
                                    <input type="text" class="form-control" name="tel" id="basic-url" aria-describedby="basic-addon3" value="<?= $_SESSION['tel'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <h3 class="alert alert-secondary"><a class="btn btn-success">ขั้นตอนที่ 2</a> : เลือกวิธีการจัดส่งและชำระค่าบริการ</h3>
                        <br>
                        <div class="row">
                            <div class="col-12">
                                <center>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3" style="display: none" id="show_address">
                                ...
                                <br>
                                <center>
                                    <a class="btn btn-primary" style="margin-left: 20px" href="#" onclick="openModalPay('payadd')">ดูบิลใบเสร็จเพื่อชำระค่าบริการ</a>
                                </center>
                                <br>
                                <hr>
                            </div>
                                    ...
                                    <script>
                                        ...
                                        function confirmPayment_Add() {
                                            Swal.fire({
                                                title: 'ยืนยันการชำระเงิน',
                                                // text: 'คุณแน่ใจหรือไม่ที่ต้องการที่จะทำการชำระเงินแล้ว?',
                                                text: 'โปรดตรวจสอบข้อมูลทั้งหมดของคุณว่าถูกต้องแล้ว2?',
                                                icon: 'warning',
                                                showCancelButton: true,
                                                confirmButtonText: 'ใช่, ชำระเงินแล้ว',
                                                cancelButtonText: 'ไม่, ยกเลิก',
                                                ...
                                                if (result.isConfirmed) {
                                                    // User confirmed, submit the form
                                                    document.getElementById('payment_data_add').submit();
                                                }
                                            });
                                        }
                                    </script>
